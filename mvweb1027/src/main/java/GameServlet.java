...
public class GameServlet extends HttpServlet {
  ...
  public void generateTryAgainResponse(HttpServletRequest request,HttpServletResponse response,
		  int remainder,String m)
	 throws IOException {
    ...
    out.println("<h1><html><head></head><body>");
  ...
  public void generateYouWinResponse(HttpServletRequest request,HttpServletResponse response)
	 throws IOException {
